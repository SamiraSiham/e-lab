...
function P(n3, l5, u5, t4, i5, o4, r4, f5, e4, c4, s5) {
  ...
  for (u5.__d = e4, $(u5, l5, _5), e4 = u5.__d, a4 = 0; a4 < g5; a4++) null != (y4 = u5.__k[a4]) && (p5 = -1 === y4.__i ? h : _5[y4.__i] || h, y4.__i = a4, O(n3, y4, p5, i5, o4, r4, f5, e4, c4, s5), d5 = y4.__e, y4.ref && p5.ref != y4.ref && (p5.ref && E(p5.ref, null, y4), s5.push(y4.ref, y4.__c || d5, y4)), null == w4 && null != d5 && (w4 = d5), 65536 & y4.__u || p5.__k === y4.__k ? e4 = I(y4, e4, n3) : "function" == typeof y4.type && void 0 !== y4.__d ? e4 = y4.__d : d5 && (e4 = d5.nextSibling), y4.__d = void 0, y4.__u &= -196609);
  u5.__d = e4, u5.__e = w4;
}
function $(n3, l5, u5) {
  ...
  if (s5) for (t4 = 0; t4 < c4; t4++) null != (o4 = u5[t4]) && 0 == (131072 & o4.__u) && (o4.__e == n3.__d && (n3.__d = x(o4)), N(o4, o4));
}
function I(n3, l5, u5) {
  var t4, i5;
...
function L(n3, l5, u5, t4) {
  ...
  if (("function" != typeof o4 || o4 === b || i5) && t4 > (null != e4 && 0 == (131072 & e4.__u) ? 1 : 0)) for (; r4 >= 0 || f5 < l5.length; ) {
    if (r4 >= 0) {
...
function F(n3) {
  return function(u5) {
    if (this.l) {
      ...
      return l.event && (u5 = l.event(u5)), "handleEvent" in t4 ? t4.handleEvent(u5) : t4(u5);
    }
  };
}
function O(n3, u5, t4, i5, o4, r4, f5, e4, c4, s5) {
  var a4, h4, v5, p5, w4, _5, g5, m3, x3, C3, S2, M3, $3, I3, H3, L2, T4 = u5.type;
  if (void 0 !== u5.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), r4 = [e4 = u5.__e = t4.__e]), (a4 = l.__b) && a4(u5);
  n: if ("function" == typeof T4) try {
    if (m3 = u5.props, x3 = "prototype" in T4 && T4.prototype.render, C3 = (a4 = T4.contextType) && i5[a4.__c], S2 = a4 ? C3 ? C3.props.value : a4.__ : i5, t4.__c ? g5 = (h4 = u5.__c = t4.__c).__ = h4.__E : (x3 ? u5.__c = h4 = new T4(m3, S2) : (u5.__c = h4 = new k(m3, S2), h4.constructor = T4, h4.render = V), C3 && C3.sub(h4), h4.props = m3, h4.state || (h4.state = {}), h4.context = S2, h4.__n = i5, v5 = h4.__d = true, h4.__h = [], h4._sb = []), x3 && null == h4.__s && (h4.__s = h4.state), x3 && null != T4.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, T4.getDerivedStateFromProps(m3, h4.__s))), p5 = h4.props, w4 = h4.state, h4.__v = u5, v5) x3 && null == T4.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), x3 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
    else {
      if (x3 && null == T4.getDerivedStateFromProps && m3 !== p5 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m3, S2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m3, h4.__s, S2) || u5.__v === t4.__v)) {
      ...
      null != h4.componentWillUpdate && h4.componentWillUpdate(m3, h4.__s, S2), x3 && null != h4.componentDidUpdate && h4.__h.push(function() {
        h4.componentDidUpdate(p5, w4, _5);
      });
    }
    if (h4.context = S2, h4.props = m3, h4.__P = n3, h4.__e = false, $3 = l.__r, I3 = 0, x3) {
      for (h4.state = h4.__s, h4.__d = false, $3 && $3(u5), a4 = h4.render(h4.props, h4.state, h4.context), H3 = 0; H3 < h4._sb.length; H3++) h4.__h.push(h4._sb[H3]);
      h4._sb = [];
    } else do {
      h4.__d = false, $3 && $3(u5), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
    } while (h4.__d && ++I3 < 25);
    h4.state = h4.__s, null != h4.getChildContext && (i5 = d(d({}, i5), h4.getChildContext())), x3 && !v5 && null != h4.getSnapshotBeforeUpdate && (_5 = h4.getSnapshotBeforeUpdate(p5, w4)), P(n3, y(L2 = null != a4 && a4.type === b && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u5, t4, i5, o4, r4, f5, e4, c4, s5), h4.base = u5.__e, u5.__u &= -161, h4.__h.length && f5.push(h4), g5 && (h4.__E = h4.__ = null);
  } catch (n4) {
...
function j(n3, u5, t4) {
  u5.__d = void 0;
  for (var i5 = 0; i5 < t4.length; i5++) E(t4[i5], t4[++i5], t4[++i5]);
...
function N(n3, u5, t4) {
  var i5, o4;
  if (l.unmount && l.unmount(n3), (i5 = n3.ref) && (i5.current && i5.current !== n3.__e || E(i5, null, u5)), null != (i5 = n3.__c)) {
  ...
  if (i5 = n3.__k) for (o4 = 0; o4 < i5.length; o4++) i5[o4] && N(i5[o4], u5, t4 || "function" != typeof n3.type);
...
c2.__b = function(n3) {
  ...
  })) : (i5.__h.forEach(z2), i5.__h.forEach(B), i5.__h = [], t2 = 0)), u3 = r2;
...
(I2.prototype = new k()).isPureReactComponent = true, I2.prototype.shouldComponentUpdate = function(n3, t4) {
...
}, (W.prototype = new k()).__c = function(n3, t4) {
  var e4 = t4.__c, r4 = this;
  null == r4.o && (r4.o = []), r4.o.push(e4);
  var u5 = P3(r4.__v), o4 = false, i5 = function() {
...
function Z(n3) {
  ...
  e4.componentWillUnmount = function() {
    q(null, e4.v), e4.v = null, e4.h = null;
  ...
  } }), q(_(H2, { context: e4.context }, n3.__v), e4.v);
}
function Y(n3, e4) {
  var r4 = _(Z, { __v: n3, h: e4 });
  return r4.containerInfo = e4, r4;
}
(z3.prototype = new k()).__a = function(n3) {
  var t4 = this, e4 = P3(t4.__v), r4 = t4.l.get(n3);
  return r4[0]++, function(u5) {
    var o4 = function() {
      t4.props.revealOrder ? (r4.push(u5), B3(t4, n3, r4)) : u5();
    };
    e4 ? e4(o4) : o4();
  };
  ...
  "string" == typeof n3.type && function(n4) {
    ...
    for (var i5 in t4) {
      ...
      if (!("value" === i5 && "defaultValue" in t4 && null == c4 || K && "children" === i5 && "noscript" === e4 || "class" === i5 || "className" === i5)) {
        ...
        "defaultValue" === i5 && "value" in t4 && null == t4.value ? i5 = "value" : "download" === i5 && true === c4 ? c4 = "" : "translate" === f5 && "no" === c4 ? c4 = false : "o" === f5[0] && "n" === f5[1] ? "ondoubleclick" === f5 ? i5 = "ondblclick" : "onchange" !== f5 || "input" !== e4 && "textarea" !== e4 || Q(t4.type) ? "onfocus" === f5 ? i5 = "onfocusin" : "onblur" === f5 ? i5 = "onfocusout" : G2.test(i5) && (i5 = f5) : f5 = i5 = "oninput" : o4 && q3.test(i5) ? i5 = i5.replace(J, "-$&").toLowerCase() : null === c4 && (c4 = void 0), "oninput" === f5 && u5[i5 = f5] && (i5 = "oninputCapture"), u5[i5] = c4;
      }
    }
...
function AppWrapper({ $app }) {
  ...
  if ($app.config.teleportTo)
    appPopupJSX = Y(appPopupJSX, $app.config.teleportTo);
...
var CalendarApp = class {
  ...
  render(el) {
    q(_(CalendarWrapper, { $app: this.$app }), el);
  }
  setTheme(theme) {
...
var createInternalConfig = (config2, plugins) => {
  return new CalendarConfigBuilder().withLocale(config2.locale).withFirstDayOfWeek(config2.firstDayOfWeek).withDefaultView(config2.defaultView).withViews(config2.views).withDayBoundaries(config2.dayBoundaries).withWeekOptions(config2.weekOptions).withCalendars(config2.calendars).withPlugins(plugins).withIsDark(config2.isDark).withIsResponsive(config2.isResponsive).withCallbacks(config2.callbacks).withMinDate(config2.minDate).withMaxDate(config2.maxDate).withMonthGridOptions(config2.monthGridOptions).withBackgroundEvents(config2.backgroundEvents).build();
};
var Month;
(function(Month2) {
...
var PreactView = class {
  ...
  render(onElement, $app) {
    q(_(this.Component, { $app, id: this.randomId }), onElement);
  }
  destroy() {
...
var invokeOnEventDoubleClickCallback = ($app, calendarEvent) => {
...
function TimeGridBackgroundEvent({ backgroundEvent, date }) {
  ...
  return u2(b, { children: u2("div", { class: "sx__time-grid-background-event", title: backgroundEvent.title, style: {
...
function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
  ...
  }, children: [fullDayBackgroundEvent && u2(b, { children: u2("div", { className: "sx__month-grid-background-event", title: fullDayBackgroundEvent.title, style: {
    ...fullDayBackgroundEvent.style
  } }) }), u2("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? u2("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale.value) }) : null, u2("div", { className: dateClassNames.join(" "), children: dayDate.getDate() })] }), u2("div", { className: "sx__month-grid-day__events", children: Object.values(day.events).slice(0, $app.config.monthGridOptions.value.nEventsPerDay).map((event, index) => {
...
function MonthAgendaEvent({ calendarEvent }) {
  ...
  return u2("div", { className: "sx__event sx__month-agenda-event", "data-ccid": customComponentId, "data-event-id": calendarEvent.id, style: {
    ...
    borderLeft: customComponent ? void 0 : eventCSSVariables.borderLeft,
    padding: customComponent ? "0px" : void 0
  }, onClick: (e4) => onClick(e4), onDblClick: (e4) => onDoubleClick(e4), onKeyDown, tabIndex: 0, role: "button", children: [!customComponent && !hasCustomContent && u2(b, { children: [u2("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), u2("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [u2(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), u2("div", { dangerouslySetInnerHTML: {
